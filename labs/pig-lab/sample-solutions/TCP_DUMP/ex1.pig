...
FILTERED_A = FOREACH A GENERATE ip_c, ip_s; 
B = GROUP FILTERED_A BY ip_c;
C = FOREACH B GENERATE group, COUNT(FILTERED_A) AS nb_connections;

STORE C INTO '/user/group001/pig/TCP_DUMP/ex1A';
